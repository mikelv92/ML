...
class Level1(tools._State):
    ...
    def is_mario_dead(self):
        return self.mario.dead

    def is_killed_enemy(self):
        if self.killed_enemy:
            self.killed_enemy = False
            return True
        else: 
            return False
    
    def is_mario_big(self):
        return self.mario.big

    def is_mario_invincible(self):
        return self.mario.invincible

    def is_mario_in_castle(self):
        return self.mario.in_castle

    def is_mario_fireball(self):
        return self.mario.allow_fireball
